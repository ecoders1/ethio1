...
import { ArrowRight, BookOpen, Target, BarChart3, Trophy } from "lucide-react";
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-6xl">
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="dark:text-slate-400 text-slate-600 max-w-2xl mx-auto">
              Comprehensive preparation tools designed specifically for Ethiopian university exit exams
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {FEATURES.map((feature, i) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="p-6 rounded-2xl dark:bg-white/5 bg-white shadow-sm border dark:border-white/10 border-slate-100 group"
              >
                <div
                ...
                <h3 className="font-bold dark:text-white text-slate-800 mb-2">{feature.title}</h3>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="dark:text-slate-400 text-slate-600 mb-8 max-w-xl mx-auto">
              Join thousands of Ethiopian students who have already transformed their exam
              preparation experience.
            </p>
            <Link
              href="/auth/signup"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white text-lg transition-all hover:scale-105 hover:shadow-xl hover:shadow-purple-500/30"
              style={{ background: "linear-gradient(135deg, #7c3aed, #3b82f6)" }}
            >
              Create Free Account
        ...
        <motion.div
          ...
          className="text-center mt-12 py-6 border-t dark:border-white/10 border-slate-100"
        >
